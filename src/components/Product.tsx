    ...
    <div className="group w-64 overflow-hidden">
      ...
      <div className="flex flex-col bg-zinc-700 p-4 text-slate-100">
        ...
        <button
          ...
          className="mt-4 border border-transparent bg-slate-100 py-2 px-4 text-zinc-700 transition-colors hover:border-slate-100 hover:bg-transparent hover:text-slate-100"
        >
          Add to cart
        </button>
      </div>
